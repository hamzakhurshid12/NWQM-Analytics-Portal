    ...
    <div class="main-wrapper">
        ...
        <nav id="sidebar" class="active">
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="Bacterial Classification.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle list-menu">Bacterial Classification</a>
                </li>
            </ul>
        </nav>
        <!-- /.Sidebar  -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="content col-12">
                            <h1>Bacterial Classification</h1>
                            <ul>
                                <li><a href="NWQM - Home Page.php">Home</a></li>
                                <li class="current"><a href="#">Bacterial Classification</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body card-block">
                            <form id="#" class="form-horizontal" style="padding-bottom: 0px">
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="select" class=" form-control-label" style="font-size: 18px">Enter the Parameter</label></div>
                        ...
                        <div class="card-footer" style="align-content: center;">
                            <center>
                            <button type="submit" class="btn btn-primary" onclick="#" form="" style="background-color: black; align-content: center;">
                                     Enter
                                </button>
                                </center>
                        </div>
