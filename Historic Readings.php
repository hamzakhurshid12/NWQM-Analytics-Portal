    ...
    ?>
            ...
            <section role="main" class="content-body" style="width: 100%">
                    <div class="panel-body" style="width: 100%">
                        <table class="table table-striped table-dark" style="align-content: center" id="datatable-ajax" data-url="assets/ajax/water-data.json">
                            <thead class="thead-dark">
                                <tr style="width: 100%;font-weight: bold;font-size: 15px">
                                    <th width="20%">Date</th>
